...
Run install.bat
Open config.ini and setup your instagram account

MODES:
main - like tag photos
love - like user photos
comment - spam comments to user

If you run the script without command line the default mode is main
